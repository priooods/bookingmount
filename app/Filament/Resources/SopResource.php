...
{
    protected static ?string $model = TSopTab::class;
    protected static ?string $navigationGroup = 'Master';
    protected static ?string $navigationLabel = 'SOP';
    protected static ?string $breadcrumb = "SOP";
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
            TextInput::make('filename')->label('Nama File')->placeholder('Masukan nama file SOP')->required(),
            FileUpload::make('file_path')->label('Pilih File sop')
            ...
            ->actions([
                ActionGroup::make([
                    ...
                    Action::make('published')
                        ...
                        ->modalHeading('Publish SOP Pendakian')
                        ->modalDescription('Apakah anda yakin ingin Publish SOP Pendakian ?')
                    ...
                    Action::make('unpublished')
                        ...
                        ->color('danger')
                        ->requiresConfirmation()
                        ->modalHeading('Un-Publish SOP Pendakian')
                        ->modalDescription('Apakah anda yakin ingin Un-Publish SOP Pendakian ?')
